		...
		function showContent(result) {
			...
			body.innerHTML = '<div class="head"> <img class="headImg" src="' + result.personlogo + '"/> <div class="username">' +
				result.name + '</div> </div>' + '<div class="content"> <div >' + result.describe + '</div>';
			body.innerHTML += '<div class="date">' + result.date + '</div></div>';
